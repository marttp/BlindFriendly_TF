...
public class TextSpeech extends UtteranceProgressListener implements TextToSpeech.OnInitListener, TextToSpeech.OnUtteranceCompletedListener {
    public static TextSpeech myTTS;

    public static TextSpeech getInstance(Context context) {
        if (myTTS == null) {
            myTTS = new TextSpeech(context);
        }
        return myTTS;
    }
    ...
    public TextSpeech setEngine(String packageName) {
        enginePackageName = packageName;
        return this;
    }

    public TextSpeech setLocale(Locale locale) {
        this.locale = locale;
        return this;
    }
